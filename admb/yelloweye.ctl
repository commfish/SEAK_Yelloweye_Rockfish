...
## -------------------------------------------------------------------------- ##
#  M_switch to estimate (1) or fix (2) natural mortality;
#  Apparently, if set to 2, it's not necessary to mck with estimation phases
#    in log_natural_mortality below
